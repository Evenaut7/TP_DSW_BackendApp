...
tagMusica.descripcion = 'Eventos y lugares relacionados con géneros musicales.';
tagMusica.tipo = 'Evento';
await em.persistAndFlush(tagMusica);
const tagHistorico = new Tag();
tagHistorico.nombre = 'Histórico';
tagHistorico.descripcion = 'Puntos de interés con valor histórico o patrimonial.';
...
tagAireLibre.descripcion = 'Actividades y lugares para disfrutar al exterior.';
...
tagGastronomia.descripcion = 'Experiencias culinarias, restaurantes y ferias de comida.';
...
tagDeporte.descripcion = 'Eventos deportivos, ligas y lugares para practicar deportes.';
tagDeporte.tipo = 'Evento';
await em.persistAndFlush(tagDeporte);
const tagCultura = new Tag();
tagCultura.nombre = 'Cultura';
tagCultura.descripcion = 'Museos, galerías de arte, teatros y expresiones culturales.';
tagCultura.tipo = 'Punto de Interés';
await em.persistAndFlush(tagCultura);
const tagCompras = new Tag();
tagCompras.nombre = 'Compras';
tagCompras.descripcion = 'Centros comerciales, mercados y tiendas de interés.';
...
tagTecnologia.descripcion = 'Charlas de tecnología, meetups, lugares de innovación.';
...
pdiParqueIndependencia.descripcion = 'Uno de los parques urbanos más grandes y antiguos de Rosario, hogar de museos, el Rosedal, el Laguito y el estadio del club más grande del interior, Newell\'s Old Boys.';
...
v1.comentario = 'Pésimo lugar, muy sucio y descuidado. No lo recomiendo.';
v1.cantEstrellas = 1;
