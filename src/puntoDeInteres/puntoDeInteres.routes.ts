...
puntoDeInteresRouter.get(
  '/usuarioPdis',
  sessionData,
  creatorValidator,
  puntoDeInteresController.getAllFromUsuarioLogeado
);
...
puntoDeInteresRouter.post(
  '/',
  sessionData,
  adminOrCreatorValidator,
  schemaValidator(puntoDeInteresSchema),
  puntoDeInteresController.add
);
// Rutas Protegidas - Solo Admin o Dueño del PDI (Validado en Controlador)
puntoDeInteresRouter.get(
  '/canEdit/:id',
  sessionData,
  adminOrPdiOwnerValidator,
  puntoDeInteresController.findOne
);
puntoDeInteresRouter.put(
  '/:id',
  sessionData,
  adminOrPdiOwnerValidator,
  schemaValidator(puntoDeInteresUpdateSchema),
  puntoDeInteresController.update
);
puntoDeInteresRouter.delete(
  '/:id',
  sessionData,
  adminOrPdiOwnerValidator,
  puntoDeInteresController.remove
);
