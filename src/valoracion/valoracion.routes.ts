...
valoracionRouter.post(
  '/',
  sessionData,
  schemaValidator(valoracionSchema),
  valoracionController.add
);

valoracionRouter.put(
  '/:id',
  sessionData,
  adminOrValorationOwnerValidator,
  schemaValidator(valoracionUpdateSchema),
  valoracionController.update
);
valoracionRouter.delete(
  '/:id',
  sessionData,
  adminOrValorationOwnerValidator,
  valoracionController.delete
);
