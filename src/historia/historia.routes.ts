...
historiaRouter.get(
  '/:id',
  sessionData,
  adminOrHistoriaOwnerValidator,
  schemaValidator(historiaSchema),
  historiaControler.findOne
);
historiaRouter.post(
  '/',
  sessionData,
...
historiaRouter.put(
  ...
  sessionData,
  adminOrHistoriaOwnerValidator,
  schemaValidator(historiaUpdateSchema),
  historiaControler.update
);
